...
const draggingEventClasses = {
    ...
    block1Active: 'template-10-block-1 blocks',
    block2: 'template-10-block-2 blocks',
    block2Active: 'template-10-block-2 blocks',
    block3: 'template-10-block-3 blocks',
    block3Active: 'template-10-block-3 blocks',
    block4: 'template-10-block-4 blocks',
    block4Active: 'template-10-block-4 blocks'
};
