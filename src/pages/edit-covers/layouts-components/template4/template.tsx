...
import 'assets/css/template-styles/template4.css';
import TemplateBloc from '../block';
import { findStyleParameters } from 'utils/helpers';

const draggingEventClasses = {
    draggingEventLeftActive: 'template-4-block__left-block blocks yes',
    draggingEventLeft: 'template-4-block__left-block blocks',
    draggingEventRightActive: 'template-4-block-2 blocks yes',
    draggingEventRight: 'template-4-block-2 blocks'
};
...
function Template4({ status, bookPage }: IThisProps) {
    ...
    return (
        <div
            ...
            <div className="template-4-block">
                <TemplateBloc
                    status={status}
                    pageItem={
